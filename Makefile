...
obj/centralmon.o: centralmon.cpp ../common/Makefile
	...
	if test "$(MAKE_UNAME)" = "Linux"; then g++ -Wall -ggdb -c centramon.cpp -o $@ -DLINUX $(CPPFLAGS) -I/data/extras/include -I../common; elif test "$(MAKE_UNAME)" = "SunOS"; then g++ -Wall -ggdb -c centralmon.cpp -o $@ -DSOLARIS $(CPPFLAGS) -I/data/extras/include -I/usr/local/ssl/include -I../common; fi;

obj/centralmond.o: centralmond.cpp ../common/Makefile
	-if [ ! -d obj ]; then mkdir obj; fi;
	if test "$(MAKE_UNAME)" = "Linux"; then g++ -Wall -ggdb -c centralmond.cpp -o $@ -DLINUX $(CPPFLAGS) -I/data/extras/include -I../common; elif test "$(MAKE_UNAME)" = "SunOS"; then g++ -Wall -ggdb -c centralmond.cpp -o $@ -DSOLARIS $(CPPFLAGS) -I/data/extras/include -I/usr/local/ssl/include -I../common; fi;

obj/centralmon_trigger.o: centralmon_trigger.cpp ../common/Makefile
	-if [ ! -d obj ]; then mkdir obj; fi;
	if test "$(MAKE_UNAME)" = "Linux"; then g++ -Wall -ggdb -c centralmon_trigger.cpp -o $@ -DLINUX $(CPPFLAGS) -I/data/extras/include -I../common; elif test "$(MAKE_UNAME)" = "SunOS"; then g++ -Wall -ggdb -c centralmon_trigger.cpp -o $@ -DSOLARIS $(CPPFLAGS) -I/data/extras/include -I/usr/local/ssl/include -I../common; fi;
